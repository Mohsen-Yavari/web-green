import man1 from "./img/man1.avif";
import man2 from "./img/man2.avif";
import man3 from "./img/man3.avif";
import man4 from "./img/man4.avif";
import man5 from "./img/man5.avif";
import man6 from "./img/man6.avif";
import man7 from "./img/man7.avif";

export const homedata = [
    {
      id: 1,
      name: "من محسن یاوری هستم",
      desc: "من خدمات طراحی وب سایت انجام میدهم",
      cover: man1,
      signature:man2
    },
    {
      id: 2,
      name: "من ایده های خلاقانه زیادی دارم",
      desc: "کار با تمرکز قوی بر روی طراحی و تجربه کاربر. من تجربیات دیجیتالی را برای برندها و شرکت ها ایجاد می کنم",
      cover: man3,
      signature:man4
    },
    {
      id: 3,
      name: "بله من به کیفیت اعتقاد دارم",
      desc: "کار با تمرکز قوی بر روی طراحی و تجربه کاربر. من تجربیات دیجیتالی را برای برندها و شرکت ها ایجاد می کنم",
      cover:man7,
      signature: man6
    },
